...
public class KhachHangFrame extends javax.swing.JFrame {
    ...
    private void paintKH() {
        ...
        for (KhachHang k : listAll) {
            ...
            btnTemp.setText("                  " + k.getMAKH() + "                               " + k.getTENKH());
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(btnTKNC, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnOKE1, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap())
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        // TODO add your handling code here:
        if (txtSearch.getText().isBlank()) listAll= KHDAO.queryAllKhachHang();
        else {
            List<KhachHang> matches1 = listAll.stream().filter(it -> it.getMAKH().contains(txtSearch.getText())).collect(Collectors.toList());
            listAll.removeAll(listAll);
            listAll.addAll(matches1);
        }
        dateChange();
