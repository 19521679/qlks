...
public class DatPhong extends javax.swing.JFrame {
    ...
    private void paintPH() {
        ...
        if (listPhong != null && !listPhong.isEmpty()) {
            ...
            for (Phong p : listPhong) {
                ...
                String textOut = "MAPH: " + p.getMAPH() + "  |  Số người: ";

                List<ThuePhong> listthue = listThuePh.stream().filter(it -> it.getMAPH().toString().contains(p.getMAPH())).collect(Collectors.toList());
                if (!listthue.isEmpty()) textOut += listthue.get(0).getSONGUOITHUE();

                btnTemp.setText(textOut);
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/poster/Datphong.png"))); // NOI18N
        ...
        btnCKH.setBackground(MyColor.button);
        ...
        btnCPH.setBackground(MyColor.button);
        ...
        btnSet.setBackground(new java.awt.Color(255, 204, 204));
    ...
    private void btnCKHActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCKHActionPerformed
        // TODO add your handling code here:
        ...
        //từ đây trở lên là trước khi luồng chính bị đóng
        threadGui.start();
    }//GEN-LAST:event_btnCKHActionPerformed
