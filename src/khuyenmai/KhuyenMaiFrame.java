...
public class KhuyenMaiFrame extends javax.swing.JFrame {
    ...
    private Image image = Toolkit.getDefaultToolkit().createImage(this.getClass().getResource("/drawable/background/khuyenmaipanel.png"));
    ...
    private void paintKM() {
        for (KhuyenMai k : listKM) {
            ...
            String ngbd;
            String ngkt;
            if (k.getNGBD() == null) ngbd = "Tất cả các ngày";
            else ngbd = format.format(k.getNGBD());
            noidung += ngbd + "                 ";

            if (k.getNGKT() == null) ngkt = "Tất cả các ngày";
            else ngkt = format.format(k.getNGKT());
            noidung += ngkt;
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/poster/Khuyenmai.png"))); // NOI18N
        ...
        btnTKNC.setBackground(new java.awt.Color(255, 204, 204));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(btnTKNC, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 160, Short.MAX_VALUE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(btnTKNC, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 122, Short.MAX_VALUE)
                        .addComponent(btnOKE1, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE))
